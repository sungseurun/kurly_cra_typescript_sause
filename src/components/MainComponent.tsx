...
function MainComponent({회원관리, openModal, isTimerHp, timerStopHp}: any) {
   ...
   const {
            ...
            생년, 생월, 생일, birthGuideText, isBirthGuideText,
   ...
   const onClickIdOk=(e: MouseEvent<HTMLButtonElement>)=>{
      let regExp2 : RegExp = /.{6,16}/g;   // 글자수는 6 ~ 16
      let regExp3 : RegExp = /(?=.*[A-Za-z])+(?=.*[0-9])*/g;  // 영문(대소문자) 필수 포함, 숫자 선택 포함 : ()+()* ==>  영문 (?=.*[A-Za-z])+ 또는 숫자 (?=.*[0-9])*
      let regExp4 : RegExp = /\s/g;   // 공백문자
      let isLogic : boolean = false;
      let message : string = '';
   ...
   const onChangeHpOk=(e: ChangeEvent<HTMLInputElement>)=>{
      ...
      setState({...state, isHpOkbtnDisabled: imsi, 인증번호확인입력값: value});
      // console.log('상태값 ', 인증번호확인입력값 );
   }
   ...
   // 9. 주소검색 버튼 클릭 이벤트 : 세션저장된 데이터 가져오기 그리고 주소 데이터 입력상자에 유지하기
   const onClickAddressSearch=(e: MouseEvent<HTMLButtonElement>)=>{
      ...
      // 부모창 이름 : opener : opener.입력상자.value = '전달내용'
      // 자식창 이름 : winPopup : winPopup.입력상자.value = '전당내용'
   }
                           ...
                           <ul>
                              ...
                              <li>
                                    ...
                                    <div className="right addr">
                                       ...
                                       ><img src="./img/search.svg" alt=""/>주소검색
                                       </button>
                                       <input 
                                       type="text" 
                                       id='addr1' 
                              ...
                              <li>
                                    ...
                                    <div className="right gender">
                                       ...
                                       <label>
                                          ...
                                          value='여자'
                                          onChange={onChangeGender}
                                          checked={성별.includes('여자')} // 뒤에 true/false 지워도 됨
                                          />여자</label>
                                       <label>
                                          <input
                                           type="radio" 
                              ...
                              <li>
                                    ...
                                    <div className="right birth-day">
                                       ...
                                       <p className={`${isBirthGuideText ? 'on' : ''}`}>{birthGuideText}</p>  {/* 3항연산자 => on 이 아니면 공백'' */}
                                    </div>
                              </li>
                              <li>
                                    ...
                                    <div className="right gender add-input">
                                       ...
                                       <div className="add-input-box">
                                          ...
                                          <label>
                                             ...
                                             value='참여 이벤트명'
                                             onChange={onChangeAddInputRadio}
                                             checked={추가입력사항.includes('참여이벤트명')}
                                             />참여 이벤트명</label>
                                       </div>
                                          ...
                                          <li>
                                                <label>
                                                   ...
                                                   type="checkbox"
                                                    ...
                                                    checked={이용약관동의.length>=7} // ?true:false ==> 이거를 제거함
                                                    />전체동의합니다
                                                </label>
